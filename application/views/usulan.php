               ...
               <div class="box-body">
                 <table id="example2" class="table table-striped table-bordered table-hover">
                   ...
                   <tr>
                     ...
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/1/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                   ...
                   <tr>
                     ...
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/2/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger" disabled>Memorandum</a> | <a href="#" class="btn btn-danger" disabled>Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">3</td>
                     <td>MAHKAMAH KONSTITUSI (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/3/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                   ...
                   <tr>
                     ...
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/4/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">5</td>
                     <td>KEMENTERIAN KOORDINATOR BIDANG POLITIK HUKUM DAN KEAMANAN (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/5/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">6</td>
                     <td>KEMENTERIAN KOORDINATOR BIDANG PEREKONOMIAN (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/6/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">7</td>
                     <td>KEMENTERIAN KOORDINATOR BIDANG PEMBANGUNAN MANUSIA DAN KEBUDAYAAN (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/7/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">8</td>
                     <td>KOORDINATOR BIDANG KEMARITIMAN DAN SUMBER DAYA (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/8/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">9</td>
                     <td>KEMENTERIAN SEKRETARIAT NEGARA (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/9/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">10</td>
                     <td>KEMENTERIAN DALAM NEGERI (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data/10/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">11</td>
                     <td>KEMENTERIAN LUAR NEGERI (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data//11/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   <tr>
                     <td style="text-align: center;">12</td>
                     <td>KEMENTERIAN PERTAHANAN (100) Orang</td>
                     <td style="text-align: center;"><a href="<?php echo site_url('Verifikasi/data//12/1'); ?>" class="btn btn-primary">Lihat Detail</a></td>
                     <td style="text-align: center;"><a href="#" class="btn btn-danger">Memorandum</a> | <a href="#" class="btn btn-danger">Daftar Pengusul GTK</a></td>
                   </tr>
                   </tbody>
                 </table>
